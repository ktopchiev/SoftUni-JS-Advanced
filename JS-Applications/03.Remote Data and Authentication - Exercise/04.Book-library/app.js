...
const [notification, cancelBtn] = [document.querySelector('.notification'), document.getElementById('cancelBtn')];
...
async function createBook(e) {
    ...
    try {
        ...
        notification.textContent = error.toString().replace('Error: ', '');
